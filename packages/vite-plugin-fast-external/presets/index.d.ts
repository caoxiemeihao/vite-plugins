...
export declare const react_router_dom_v5: () => string
export declare const react_router_dom_v6: () => string
export declare const react_router_v5: () => string
export declare const react_router_v6: () => string
export declare const react_v17: () => string
export declare const react_v18: () => string
export declare const redux_v5: () => string
